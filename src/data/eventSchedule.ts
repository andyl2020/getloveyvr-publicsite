...
export const DEFAULT_EVENT_SCHEDULE: EventScheduleEntry[] = [
  ...
  },
  {
    ...
    joinUrl: "https://flocksocial.app/e/karaoke-season-2-ep4-friends-ed-628295",
    emoji: "\u{1F3A4}",
    colorClass: "bg-event-social",
  },
  {
  ...
  },
  {
    ...
    joinUrl: "https://flocksocial.app/e/karaoke-season-2-ep4-friends-ed-a92595",
    emoji: "\u{1F3A4}",
    colorClass: "bg-event-social",
    defaultOwner: "Stephy",
  },
  {
    ...
    seriesType: "friends",
    title: "Karaoke S2 E6 (Friends Edition)",
    boardTheme: "Karaoke S2 E6 (Friends Edition)",
    eventDate: "2026-09-11",
    joinUrl: "https://flocksocial.app/e/karaoke-season-2-ep5-friends-ed-10f423",
    emoji: "\u{1F3A4}",
    colorClass: "bg-event-social",
    defaultOwner: "Stephy",
  },
  {
    ...
    seriesType: "singles",
    title: "Hiking Carpool Pre-Meet",
    boardTheme: "Hiking Carpool Pre-Meet",
  ...
  },
  {
    ...
    seriesType: "singles",
    title: "Paddle Boarding Carpool Pre-Meet",
    boardTheme: "Paddle Boarding Carpool Pre-Meet",
  ...
  },
  {
    ...
    seriesType: "singles",
    seriesNumber: 8,
    title: "TBA Singles Event",
    boardTheme: "TBA Singles Event",
